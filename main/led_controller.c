...
void ledc_init(void)
{
    ...
    ledc_channel_config_t ledc_channel0 = {.speed_mode = LEDC_LOW_SPEED_MODE,
    ...
    ledc_channel_config_t ledc_channel1 = {.speed_mode = LEDC_LOW_SPEED_MODE,
    ...
    ledc_channel_config_t ledc_channel3 = {.speed_mode = LEDC_LOW_SPEED_MODE,
    ...
    ledc_channel_config_t ledc_channel4 = {.speed_mode = LEDC_LOW_SPEED_MODE,
    ...
    ledc_channel_config_t ledc_channel5 = {.speed_mode = LEDC_LOW_SPEED_MODE,
