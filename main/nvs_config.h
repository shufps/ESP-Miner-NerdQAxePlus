...
namespace Config {
    ...
    inline uint16_t getAsicJobInterval(uint16_t default) { return nvs_config_get_u16(NVS_CONFIG_ASIC_JOB_INTERVAL, default); }
    ...
    inline uint16_t getFanSpeed() { return nvs_config_get_u16(NVS_CONFIG_FAN_SPEED, 100); } // todo kconfig
