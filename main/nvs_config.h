...
#define NVS_CONFIG_STRATUM_FALLBACK_URL "stratumfallbackurl"
#define NVS_CONFIG_STRATUM_FALLBACK_PORT "stratumfallbackport"
#define NVS_CONFIG_STRATUM_FALLBACK_USER "stratumfallbackuser"
#define NVS_CONFIG_STRATUM_FALLBACK_PASS "stratumfallbackpass"
